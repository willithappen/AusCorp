{if ((typeOf _x == 'rhsusf_army_ocp_rifleman') && (!isPlayer _x)) then {deleteVehicle _x}} forEach allUnits;
[MedicalData7,3] call BIS_fnc_dataTerminalAnimate;
sleep 5;
_group7=createGroup west;
'rhsusf_army_ocp_rifleman' createUnit [getmarkerPos 'PatientSpawn7', _group7,'pat1=this; dostop pat1'];
...
[MedicalData7,0] call BIS_fnc_dataTerminalAnimate;

{if ((typeOf _x == 'rhsusf_army_ocp_engineer') && (!isPlayer _x)) then {deleteVehicle _x}} forEach allUnits;
[MedicalData5,3] call BIS_fnc_dataTerminalAnimate;
sleep 5;
_group5=createGroup west;
'rhsusf_army_ocp_engineer' createUnit [getmarkerPos 'PatientSpawn5', _group5,'pat1=this; dostop pat1'];

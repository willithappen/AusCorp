{if ((typeOf _x == 'rhsusf_army_ocp_machinegunner') && (!isPlayer _x)) then {deleteVehicle _x}} forEach allUnits;
[MedicalData9,3] call BIS_fnc_dataTerminalAnimate;
sleep 5;
_group9=createGroup west;
'rhsusf_army_ocp_machinegunner' createUnit [getmarkerPos 'PatientSpawn9', _group9,'pat1=this; dostop pat1'];
...
[MedicalData9,0] call BIS_fnc_dataTerminalAnimate;
